...
if __name__ == "__main__":
    video_path = r"E:\My projects\dis_librarie\input_videos\bg_video.mp4"  # Path to input video file
    output_directory = r"E:\My projects\dis_librarie\frames_extraction_HD_fps\bg_frames"  # Directory to save extracted frames
