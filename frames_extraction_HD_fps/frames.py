...
if __name__ == "__main__":
    video_path = "E:\\My projects\\dis_librarie\\input_videos\\sangetha_fg.mp4" # Path to input video file
    output_directory = "E:\\My projects\\dis_librarie\\frames_extraction_HD_fps\\fg_frames"  # Directory to save extracted frames
